...
export default function ForgotPasswordCallback() {
  ...
  useEffect(() => {
    // Optionally, you can validate the token here by calling your backend
    setError("");
    setSuccess("");
  }, [token]);
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    // Supabase handles the password reset session automatically if the user lands here from the email link
