        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <button className="group flex items-center bg-white rounded-2xl px-4 py-3 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200/60">
              ...
              <span className="ml-2 text-xs text-slate-600 font-medium">3</span>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-800 text-sm">The Midnight Library</h4>
                      <p className="text-xs text-slate-600">Due: May 30, 2025</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-14 bg-gradient-to-b from-purple-500 to-purple-600 rounded"></div>
                    <div>
                      <h4 className="font-semibold text-slate-800 text-sm">Atomic Habits</h4>
                      <p className="text-xs text-slate-600">Due: June 2, 2025</p>
                    </div>
                  </div>
                  <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                    Renew
                ...
                <div className="flex items-center justify-between p-4 bg-red-50 rounded-xl border border-red-200">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-14 bg-gradient-to-b from-red-500 to-red-600 rounded"></div>
                    <div>
                      <h4 className="font-semibold text-slate-800 text-sm">Digital Minimalism</h4>
                      <p className="text-xs text-red-600 font-medium">Overdue: May 25, 2025</p>
                    </div>
                  </div>
