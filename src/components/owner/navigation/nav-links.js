...
import { FaCalendarCheck, FaBook, FaDollarSign, FaUser } from 'react-icons/fa';
...
const links = [
  ...
  },
  {
    ...
    icon: FaDollarSign,
    subLinks: [
      { name: 'Transaction', href: '/owner/dashboard/finance/transaction' },
      { name: 'Cash Flow', href: '/owner/dashboard/finance/cash-flow' }
    ]
  }
];
